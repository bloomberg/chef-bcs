...
node.default['ceph']['radosgw']['logs']['ops']['enable'] = node['chef-bcs']['ceph']['radosgw']['logs']['ops']['enable']
node.default['ceph']['radosgw']['logs']['usage']['enable'] = node['chef-bcs']['ceph']['radosgw']['logs']['usage']['enable']
